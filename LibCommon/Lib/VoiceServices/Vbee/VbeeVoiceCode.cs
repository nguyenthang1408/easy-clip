...
namespace Lib
{
    ...
    public class VbeeVoicecode
    {
        ...
        #region "Đức - German (Germany)"
        public const string Brune_Des = "Brune";
        public const string Brune = "de-DE-Standard-A";

        public const string Brunhilda_Des = "Brunhilda";
        public const string Brunhilda = "de-DE-Standard-B";

        public const string Berrin_Des = "Berrin";
        public const string Berrin = "de-DE-Standard-C";

        public const string Bias_Des = "Bias";
        public const string Bias = "de-DE-Standard-D";

        public const string Bertha_Des = "Bertha";
        public const string Bertha = "de-DE-Standard-E";

        public const string Bill_Des = "Bill";
        public const string Bill = "de-DE-Standard-F";
        #endregion

        #region "Hàn Quốc - Korean (South Korea)"
        public const string Moon_Des = "Moon";
        public const string Moon = "ko-KR-Standard-A";

        public const string Emils_Des = "Emils";
        public const string Emils = "ko-KR-Standard-B";

        public const string Nadia_Des = "Nadia";
        public const string Nadia = "ko-KR-Standard-C";

        public const string Alan_Des = "Alan";
        public const string Alan = "ko-KR-Standard-D";
        #endregion

        #region "Hồng Kông - Chinese (Hong Kong)"
        public const string Zhusha_Des = "Zhū Shā";
        public const string Zhusha = "yue-HK-Standard-A";

        public const string HaoXuan_Des = "Hào Xuān";
        public const string HaoXuan = "yue-HK-Standard-B";

        public const string JinYi_Des = "Jǐn Yì";
        public const string JinYi = "yue-HK-Standard-C";

        public const string YunXi_Des = "Yún Xī";
        public const string YunXi = "yue-HK-Standard-D";
        #endregion

        #region "Nga - Russian (Russia)"
        public const string Zaur_Des = "Zaur";
        public const string Zaur = "ru-RU-Standard-A";

        public const string Leposava_Des = "Leposava";
        public const string Leposava = "ru-RU-Standard-B";

        public const string Monika_Des = "Monika";
        public const string Monika = "ru-RU-Standard-C";

        public const string Adoncia_Des = "Adoncia";
        public const string Adoncia = "ru-RU-Standard-D";

        public const string Agustin_Des = "Agustin";
        public const string Agustin = "ru-RU-Standard-E";
        #endregion

        #region "Nhật bản - Japanese (Japan)"
        public const string Akemi_Des = "Akemi";
        public const string Akemi = "ja-JP-Standard-A";

        public const string Aas_Des = "Aas";
        public const string Aas = "ja-JP-Standard-B";

        public const string Bali_Des = "Bali";
        public const string Bali = "ja-JP-Standard-C";

        public const string Anu_Des = "Anu";
        public const string Anu = "ja-JP-Standard-D";
        #endregion

        #region Pháp - French (France)"
        public const string Adalene_Des = "Adalene";
        public const string Adalene = "fr-FR-Standard-A";

        public const string Adrien_Des = "Adrien";
        public const string Adrien = "fr-FR-Standard-B";

        public const string Adalicia_Des = "Adalicia";
        public const string Adalicia = "fr-FR-Standard-C";

        public const string Advent_Des = "Advent";
        public const string Advent = "fr-FR-Standard-D";

        public const string Adalie_Des = "Adalie";
        public const string Adalie = "fr-FR-Standard-E";
        #endregion

        #region Pháp (Canada) - French (Canada)"
        public const string Daphne_Des = "Daphne";
        public const string Daphne = "fr-CA-Standard-A";

        public const string Antoine_Des = "Antoine";
        public const string Antoine = "fr-CA-Standard-B";

        public const string Elisaac_Des = "Elisaac";
        public const string Elisaac = "fr-CA-Standard-C";

        public const string Abella_Des = "Abella";
        public const string Abella = "fr-CA-Standard-D";
        #endregion

        #region Tiếng Anh (Anh) - English (British)"
        public const string John_Des = "John";
        public const string John = "Emma";

        public const string Anna_Des = "Anna";
        public const string Anna = "Brian";
        #endregion
        ...
        #region Trung Quốc (Phổn thể) - Mandarin Chinese"
        public const string QingYa_Des = "Qīng Yǎ";
        public const string QingYa = "cmn-CN-Standard-A";

        public const string JunLang_Des = "Jùn Lǎng";
        public const string JunLang = "cmn-CN-Standard-B";

        public const string YiXuan_Des = "Yì Xuān";
        public const string YiXuan = "cmn-CN-Standard-C";

        public const string WanTong_Des = "Wǎn Tóng";
        public const string WanTong = "cmn-CN-Standard-D";

        public const string Frida_Des = "Frida";
        public const string Frida = "cmn-TW-Standard-A";

        public const string Edvard_Des = "Edvard";
        public const string Edvard = "cmn-TW-Standard-B";

        public const string Nikita_Des = "Nikita";
        public const string Nikita = "cmn-TW-Standard-C";
        #endregion
    }
}