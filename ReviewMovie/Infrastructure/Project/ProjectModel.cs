...
namespace ReviewMovie.Infrastructure.Project
{
    ...
    public class EffectSetting
    {
        ...
        public decimal SvolumnOrigin { get; set; }
        public decimal SscaleAudioRangeStart { get; set; }
        public decimal SscaleAudioRangeEnd { get; set; }
        public bool SrandomMoveLeftRight { get; set; }
        public int Sfps { get; set; }
        public int Sthread { get; set; }
        public string SvideoQuality { get; set; }
        public bool SvideoShort { get; set; }
        ...
        public string SlanguageSelect { get; set; }
    ...
    public class InfoRenderVd
    {
        ...
        public string MediaPath { get; set; } // link video đã chuyển đổi vào project
        ...
        public string MediaFilePath { get; set; } // link video thật 
        public string LblVdtime { get; set; }
        public string RenderStatus { get; set; }
        public bool MediaMiss { get; set; }

        public InfoRenderVd Clone()
        {
            return new InfoRenderVd
            {
                NoID = this.NoID,
                MediaPath = this.MediaPath,
                Audiotime = this.Audiotime,
                CurrentTimeOfMediaPart = this.CurrentTimeOfMediaPart,
                TimeOfMediaPart = this.TimeOfMediaPart,
                Width = this.Width,
                Height = this.Height,
                ...
                LblVdtime = this.LblVdtime,
                RenderStatus = this.RenderStatus,
                MediaMiss = this.MediaMiss
            };
        }
    }
