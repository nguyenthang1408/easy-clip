...
namespace ReviewMovie.Localization.Resources
{
    public static class Lang_vi
    {
        public static readonly Dictionary<string, string> Texts = new Dictionary<string, string>
        {
            ...
            { LangKeys.Common_Yes, "Có" },
            { LangKeys.Common_No, "Không" },
            { LangKeys.Common_OK, "OK" },
            ...
            { LangKeys.Main_ExportSubtitleTitle, "Lưu File Subtitle" },
            { LangKeys.Main_ExportSubtitleNoData, "Không có dữ liệu subtitle để xuất!" },
            ...
            { LangKeys.Svc_RenderCancelledCell, "Đã huỷ Render" },
        };
    }
}
