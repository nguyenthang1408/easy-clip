...
namespace ReviewMovie
{
    public partial class FormMain : Form
    {
        ...
        private static void ApplyCapCutThemeDefaults()
        {
            ThemeManager.Current = new ThemeColors
            {
                WindowBackColor = Color.FromArgb(17, 20, 27),
                SurfaceColor = Color.FromArgb(24, 28, 36),
                TextPrimary = Color.FromArgb(237, 242, 249),
                TextSecondary = Color.FromArgb(158, 170, 189),
                TextDisabled = Color.FromArgb(105, 117, 136),
                Border = Color.FromArgb(61, 70, 86),
                BorderFocus = Color.FromArgb(0, 196, 255),
                Accent = Color.FromArgb(0, 196, 255),
                AccentHover = Color.FromArgb(33, 209, 255),
                AccentPressed = Color.FromArgb(0, 162, 211),
                Hover = Color.FromArgb(40, 46, 58),
                Disabled = Color.FromArgb(56, 64, 78),
                SelectionBackColor = Color.FromArgb(0, 95, 126),
                SelectionForeColor = Color.White
            };
        }

        private void ApplyCapCutTheme()
        {
            var windowBackColor = ThemeManager.Current.WindowBackColor;
            var surfaceBackColor = ThemeManager.Current.SurfaceColor;
            var surfaceRaisedColor = Color.FromArgb(31, 36, 46);
            var inputBackColor = Color.FromArgb(36, 42, 54);
            var borderColor = ThemeManager.Current.Border;
            var textPrimaryColor = ThemeManager.Current.TextPrimary;
            var textSecondaryColor = ThemeManager.Current.TextSecondary;
            var accentColor = ThemeManager.Current.Accent;
            var accentHoverColor = ThemeManager.Current.AccentHover;
            var accentPressedColor = ThemeManager.Current.AccentPressed;
            var selectionBackColor = ThemeManager.Current.SelectionBackColor;
            var headerBackColor = Color.FromArgb(22, 26, 34);
            ...
            try
            {
                ...
                // Header region
                pnlHeaderTitle.BackColor = headerBackColor;
                pnlHeaderTitle.BorderStyle = BorderStyle.None;
                pnlHeaderBrand.BackColor = headerBackColor;
                tlpHeaderRight.BackColor = headerBackColor;

                lblHeaderMainTitle.ForeColor = textPrimaryColor;
                lblHeaderSubtitle.ForeColor = textSecondaryColor;

                lblHeaderLogo.BackColor = Color.FromArgb(34, 46, 63);
                lblHeaderLogo.ForeColor = accentColor;
                UiHelpers.ApplyRoundRegion(lblHeaderLogo, 6);

                lblHeaderActive.BackColor = Color.FromArgb(28, 61, 49);
                lblHeaderActive.ForeColor = Color.FromArgb(129, 244, 198);
                UiHelpers.ApplyRoundRegion(lblHeaderActive, 6);

                lblHeaderRemaining.BackColor = headerBackColor;
                lblHeaderRemaining.ForeColor = textSecondaryColor;

                lblHeaderAvatar.BackColor = Color.FromArgb(34, 46, 63);
                lblHeaderAvatar.ForeColor = accentColor;
                UiHelpers.ApplyRoundRegion(lblHeaderAvatar, 8);

                StyleHeaderButton(btnHeaderHelp, textSecondaryColor, Color.FromArgb(40, 46, 58), Color.FromArgb(49, 56, 70));
                StyleHeaderButton(btnHeaderSetting, textSecondaryColor, Color.FromArgb(40, 46, 58), Color.FromArgb(49, 56, 70));
                StyleHeaderButton(btnHeaderClose, Color.FromArgb(255, 151, 151), Color.FromArgb(72, 42, 49), Color.FromArgb(86, 48, 57));

                // Split containers and major panes
                scMain.BorderStyle = BorderStyle.None;
                scMain.BackColor = windowBackColor;
                scMain.SplitterColor = borderColor;
                scMain.BorderColorEx = borderColor;
                scMain.BorderSizeEx = 1;
                scMain.Panel1.BackColor = windowBackColor;
                scMain.Panel2.BackColor = windowBackColor;

                scView.BorderStyle = BorderStyle.None;
                scView.BackColor = windowBackColor;
                scView.SplitterColor = borderColor;
                scView.BorderColorEx = borderColor;
                scView.BorderSizeEx = 1;
                scView.Panel1.BackColor = windowBackColor;
                scView.Panel2.BackColor = windowBackColor;

                scSetting.BorderStyle = BorderStyle.None;
                scSetting.BackColor = windowBackColor;
                scSetting.SplitterColor = borderColor;
                scSetting.BorderColorEx = borderColor;
                scSetting.BorderSizeEx = 1;
                scSetting.Panel1.BackColor = windowBackColor;
                scSetting.Panel2.BackColor = windowBackColor;

                tlpView.BackColor = windowBackColor;
                tlpView.BackgroundColor = windowBackColor;
                tlpViewHeader.BackColor = Color.Transparent;
                tlpViewHeader.BackgroundColor = Color.Transparent;
                tlpImportMedia.BackColor = Color.Transparent;
                tlpImportMedia.BackgroundColor = Color.Transparent;
                tlpText.BackColor = Color.Transparent;
                tlpText.BackgroundColor = Color.Transparent;
                tlpHeaderButton.BackColor = Color.Transparent;
                tlpHeaderButton.BackgroundColor = Color.Transparent;

                // Generic control tree styling
                ApplyCapCutThemeToControlTree(this, windowBackColor, surfaceBackColor, surfaceRaisedColor, inputBackColor, borderColor, textPrimaryColor, textSecondaryColor, accentColor);

                // Highlighted chips in header content area
                lbHeaderInputMedia.BackColor = accentColor;
                lbHeaderInputMedia.BackgroundColor = accentColor;
                lbHeaderInputMedia.BorderColor = Color.FromArgb(0, 152, 200);
                lbHeaderInputMedia.TextColor = Color.FromArgb(8, 23, 33);

                lbHeaderText.BackColor = accentColor;
                lbHeaderText.BackgroundColor = accentColor;
                lbHeaderText.BorderColor = Color.FromArgb(0, 152, 200);
                lbHeaderText.TextColor = Color.FromArgb(8, 23, 33);

                // Primary action buttons
                StyleUiButton(btnOpenProject, accentColor, accentHoverColor, accentPressedColor, Color.FromArgb(8, 23, 33), Color.FromArgb(0, 152, 200));
                StyleUiButton(btnRenderVideoPart, accentColor, accentHoverColor, accentPressedColor, Color.FromArgb(8, 23, 33), Color.FromArgb(0, 152, 200));
                StyleUiButton(btnConvertAudio, accentColor, accentHoverColor, accentPressedColor, Color.FromArgb(8, 23, 33), Color.FromArgb(0, 152, 200));
                StyleUiButton(btnSaveAudio, accentColor, accentHoverColor, accentPressedColor, Color.FromArgb(8, 23, 33), Color.FromArgb(0, 152, 200));
                StyleUiButton(btnAddAll, accentColor, accentHoverColor, accentPressedColor, Color.FromArgb(8, 23, 33), Color.FromArgb(0, 152, 200));

                // Secondary action buttons
                StyleUiButton(btnRecord, surfaceRaisedColor, Color.FromArgb(40, 46, 58), Color.FromArgb(49, 56, 70), textPrimaryColor, borderColor);
                StyleUiButton(btnSaveVoiceSource, surfaceRaisedColor, Color.FromArgb(40, 46, 58), Color.FromArgb(49, 56, 70), textPrimaryColor, borderColor);
                StyleUiButton(btnSaveEffectSetting, surfaceRaisedColor, Color.FromArgb(40, 46, 58), Color.FromArgb(49, 56, 70), textPrimaryColor, borderColor);
                StyleUiButton(btnCollapse, surfaceRaisedColor, Color.FromArgb(40, 46, 58), Color.FromArgb(49, 56, 70), textSecondaryColor, borderColor);
                StyleUiButton(btnExpand, surfaceRaisedColor, Color.FromArgb(40, 46, 58), Color.FromArgb(49, 56, 70), textSecondaryColor, borderColor);

                // Text inputs
                txtImPortMedia.BackColor = inputBackColor;
                txtImPortMedia.ForeColor = textPrimaryColor;
                txtImPortMedia.BorderStyle = BorderStyle.FixedSingle;

                // Data grid theme
                dgvMainView.BackgroundColor = surfaceBackColor;
                dgvMainView.BorderColorEx = borderColor;
                dgvMainView.CellBackColor = Color.FromArgb(30, 35, 45);
                dgvMainView.CellForeColor = textPrimaryColor;
                dgvMainView.GridBackColor = surfaceBackColor;
                dgvMainView.GridColor = borderColor;
                dgvMainView.GridForeColor = textPrimaryColor;
                dgvMainView.GridLineColor = borderColor;
                dgvMainView.HeaderBackColor = Color.FromArgb(26, 31, 40);
                dgvMainView.HeaderForeColor = textPrimaryColor;
                dgvMainView.ApplyStyles();

                dgvMainView.ColumnHeadersDefaultCellStyle.BackColor = Color.FromArgb(26, 31, 40);
                dgvMainView.ColumnHeadersDefaultCellStyle.ForeColor = textPrimaryColor;
                dgvMainView.ColumnHeadersDefaultCellStyle.SelectionBackColor = Color.FromArgb(26, 31, 40);
                dgvMainView.ColumnHeadersDefaultCellStyle.SelectionForeColor = textPrimaryColor;
                dgvMainView.DefaultCellStyle.BackColor = Color.FromArgb(30, 35, 45);
                dgvMainView.DefaultCellStyle.ForeColor = textPrimaryColor;
                dgvMainView.DefaultCellStyle.SelectionBackColor = selectionBackColor;
                dgvMainView.DefaultCellStyle.SelectionForeColor = Color.White;
                dgvMainView.RowsDefaultCellStyle.BackColor = Color.FromArgb(30, 35, 45);
                dgvMainView.RowsDefaultCellStyle.ForeColor = textPrimaryColor;
                dgvMainView.RowsDefaultCellStyle.SelectionBackColor = selectionBackColor;
                dgvMainView.RowsDefaultCellStyle.SelectionForeColor = Color.White;
                dgvMainView.AlternatingRowsDefaultCellStyle.BackColor = Color.FromArgb(34, 39, 49);
                dgvMainView.AlternatingRowsDefaultCellStyle.ForeColor = textPrimaryColor;
                dgvMainView.AlternatingRowsDefaultCellStyle.SelectionBackColor = selectionBackColor;
                dgvMainView.AlternatingRowsDefaultCellStyle.SelectionForeColor = Color.White;
                dgvMainView.RowTemplate.DefaultCellStyle.SelectionBackColor = selectionBackColor;
                dgvMainView.RowTemplate.DefaultCellStyle.SelectionForeColor = Color.White;

                // ToolStrip + context menu dark style
                var stripColors = new UiToolStripColors
                {
                    BackColor = surfaceBackColor,
                    ItemForeColor = textPrimaryColor,
                    BorderColor = borderColor,
                    BorderSize = 1,
                    ItemBorderRadius = 4
                };

                tsMenuView.BackColor = surfaceBackColor;
                tsMenuView.ForeColor = textPrimaryColor;
                tsMenuView.Renderer = new UiToolStripRenderer(stripColors);
                foreach (ToolStripItem item in tsMenuView.Items)
                {
                    item.ForeColor = textPrimaryColor;
                }

                txtTim.BackColor = inputBackColor;
                txtTim.ForeColor = textPrimaryColor;
                txtTim.BorderStyle = BorderStyle.FixedSingle;

                ctMenu.BackColor = surfaceBackColor;
                ctMenu.ForeColor = textPrimaryColor;
                ctMenu.Renderer = new UiToolStripRenderer(stripColors);
                ApplyContextMenuItemColors(ctMenu.Items, textPrimaryColor);
            }
            finally
            {
                ResumeLayout(false);
        ...
        private void ApplyCapCutThemeToControlTree(
            Control root,
            ...
            Color accentColor)
        {
            ...
            foreach (Control control in root.Controls)
            {
                if (control is UiGroupBox groupBox)
                {
                    ...
                    groupBox.BackgroundColor = surfaceBackColor;
                    groupBox.BorderColorEx = borderColor;
                    groupBox.BorderSizeEx = 1;
                    groupBox.TitleBackColor = surfaceBackColor;
                    groupBox.TitleForeColor = textPrimaryColor;
                }
                else if (control is UiLabel uiLabel)
                {
                    if (!ReferenceEquals(uiLabel, lbHeaderInputMedia) && !ReferenceEquals(uiLabel, lbHeaderText))
                    {
                        uiLabel.TextColor = textSecondaryColor;
                    }
                }
                else if (control is UiTextBox uiTextBox)
                {
                    uiTextBox.BackgroundColor = inputBackColor;
                    uiTextBox.BorderColor = borderColor;
                    uiTextBox.BorderFocusColor = accentColor;
                    uiTextBox.HoverColor = Color.FromArgb(43, 49, 62);
                    uiTextBox.TextColor = textPrimaryColor;
                    uiTextBox.InnerTextBox.BackColor = inputBackColor;
                    uiTextBox.InnerTextBox.ForeColor = textPrimaryColor;
                }
                else if (control is UiComboBox uiComboBox)
                {
                    uiComboBox.BackColor = inputBackColor;
                    uiComboBox.ForeColor = textPrimaryColor;
                    uiComboBox.BorderColor = borderColor;
                    uiComboBox.BorderFocusColor = accentColor;
                    uiComboBox.BorderSize = 1;
                }
                else if (control is UiNumericUpDown uiNumeric)
                {
                    uiNumeric.BackgroundColor = inputBackColor;
                    uiNumeric.ButtonColor = inputBackColor;
                    uiNumeric.ButtonHoverColor = Color.FromArgb(43, 49, 62);
                    uiNumeric.ButtonIconColor = textSecondaryColor;
                    uiNumeric.TextColor = textPrimaryColor;
                    uiNumeric.BorderColor = borderColor;
                    uiNumeric.BorderFocusColor = accentColor;
                }
                else if (control is UiCheckBox uiCheckBox)
                {
                    uiCheckBox.TextColor = textSecondaryColor;
                    uiCheckBox.CheckedColor = accentColor;
                    uiCheckBox.UncheckedColor = borderColor;
                    uiCheckBox.BoxBorderColor = borderColor;
                    uiCheckBox.HoverColor = Color.FromArgb(43, 49, 62);
                }
                else if (control is UiRadioButton uiRadioButton)
                {
                    uiRadioButton.TextColor = textSecondaryColor;
                    uiRadioButton.CheckedColor = accentColor;
                    uiRadioButton.UncheckedColor = borderColor;
                    uiRadioButton.BoxBorderColor = borderColor;
                    uiRadioButton.HoverColor = Color.FromArgb(43, 49, 62);
                }
                else if (control is UiButton uiButton)
                {
                    StyleUiButton(uiButton, surfaceRaisedColor, Color.FromArgb(40, 46, 58), Color.FromArgb(49, 56, 70), textPrimaryColor, borderColor);
                }
                else if (control is UiTableLayoutPanel uiTableLayout)
                {
                    uiTableLayout.BackColor = Color.Transparent;
                    uiTableLayout.BackgroundColor = Color.Transparent;
                }
                else if (control is Panel panel &&
                         !ReferenceEquals(panel, pnlHeaderTitle) &&
                         !ReferenceEquals(panel, pnlHeaderBrand))
                {
                    panel.BackColor = windowBackColor;
                }
                else if (control is Label label &&
                         !ReferenceEquals(label, lblHeaderMainTitle) &&
                         !ReferenceEquals(label, lblHeaderSubtitle) &&
                         !ReferenceEquals(label, lblHeaderLogo) &&
                         !ReferenceEquals(label, lblHeaderActive) &&
                         !ReferenceEquals(label, lblHeaderRemaining) &&
                         !ReferenceEquals(label, lblHeaderAvatar))
                {
                ...
                {
                    ApplyCapCutThemeToControlTree(control, windowBackColor, surfaceBackColor, surfaceRaisedColor, inputBackColor, borderColor, textPrimaryColor, textSecondaryColor, accentColor);
                }
            }
        }

        private static void StyleUiButton(UiButton button, Color backColor, Color hoverColor, Color pressedColor, Color textColor, Color borderColor)
        {
            ...
            button.BorderHoverColor = borderColor;
            button.BorderSize = 1;
            button.BorderStyleEx = UiBorderStyle.Solid;
        }

        private static void StyleHeaderButton(Button button, Color foreColor, Color hoverBackColor, Color pressedBackColor)
        {
            if (button == null) return;
        ...
        private static void ApplyContextMenuItemColors(ToolStripItemCollection items, Color foreColor)
        {
            ...
            foreach (ToolStripItem item in items)
            {
                ...
                {
                    dropDownItem.DropDown.BackColor = ThemeManager.Current.SurfaceColor;
                    dropDownItem.DropDown.ForeColor = foreColor;
                    ApplyContextMenuItemColors(dropDownItem.DropDownItems, foreColor);
                }
            }
        }
